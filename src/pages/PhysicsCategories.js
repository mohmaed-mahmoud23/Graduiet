...
const categoriesOfPhysics = [
  { name: "Thermal", color: "#b2e2c6", icon: "/images/categories/Group 949.svg",  position: { top: 120, left: 30  } },
  { name: "Electrical", color: "#feedb5", icon: "/images/categories/Group 950.svg",  position: { top: 370, left: 300} },
  { name: "Mechanical", color: "#fbd108", icon: "/images/categories/Group 968.svg",  position: {  top:120, left: 545}  },
  { name: "Modern", color: "#fdc8c2", icon: "/images/categories/Group 969.svg",position: {top: 370, left: 820} },
];
