  ...
  return (
    <div className="container" id="home">
      ...
      <main style={{ marginTop: "70px" }}>
        ...
        >
          <div className="title">
            <h1 className="main-title" style={{ marginLeft: "0px" }}>
              <span className="highlight">Online</span> Animated Virtual Labs.
              <br /> Real Classroom
            </h1>
            <p className="subtitle">
              Amazing Experiments Teaching Your Favorite Subjects.
            </p>
          </div>
          <div className="subjects">
            ...
            <div className="subject-row">
              <button
                className="biology"
                onClick={() =>
                  role ? alert("Coming soon!") : navigate("/login")
                }
              >
                Biology
              </button>
      ...
      <section className="courses-section" id="courses">
        ...
        <div className="courses-container">
          ...
          <div
            className="course-card"
            onClick={() => (role ? alert("Coming soon!") : navigate("/login"))}
          >
            <img
              src="/images/home/geology-exploration.png"
              alt="Geology Exploration"
            />
          </div>
          <div
            className="course-card"
      ...
      <div className="about-section" id="about">
        <div className="about-text">
          ...
          <p>
            Discover The{" "}
            <span style={{ color: "#2196F3", fontWeight: "bold" }}>W</span>
            ...
            <span style={{ color: "#f06292", fontWeight: "bold" }}>d</span> Of
            Elements and Reactions with Us
          </p>
        </div>
