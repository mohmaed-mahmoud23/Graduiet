  ...
  return (
    <div className=" pl-12  experiment-layout">
      <div className="left-panel mr-24">
        ...
        <div className="chemicals-box bg-slate-300">
          <h3 className="text-center text-2xl  text-blue-700 font-extrabold">
            Chemicals
          </h3>
      ...
      <div className="center-panel" style={{ position: "relative" }}>
        <div className="device-box">
          <h2 className="device-title">Potassium Nitrate Experiment</h2>
